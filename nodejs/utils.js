...
var pattern = {
    ...
    'expNode'     : "[class*=fb-like-box],[class*=repondre],[class*=citer],[class*=follow],[class*=corps_posting],[class*=share-panel],[class*=share],[class*=facebook],[class*=twitter],[class*=googleplus],[class*=blogger],[class*=youtube],[class*=skyblog],[class*=tumblr],[class*=myspace],[class*=reddit],[class*=vkontakte],[class*=odnoklassniki],[class*=pinterest],[class*=github],[class*=linkedin],[class*=livejournal],[class*=hi5],[class*=create-comment],[class*=create-post],[class*=create-message],[class*=like],[class*=dislike],[class*=rss],[class*=reagir],[class*=imprimer],[class*=partage],[class*=ajouter],[class*=print],[class*=react],[class*=email],[class*=save],[class*=sharetool],[class*=signup],[class*=login],[class*=reply],[class*=comment-reply],[class*=commenter]",
    'cntNode'     : "p,div,li,code,blockquote,pre,h1,h2,h3,h4,h5,h6,b,i,adress,#text",
